...
pub const MOCHA_GRUVBOX: Theme = Theme {
    rosewater: Color32::from_rgb(234,105,98),
    flamingo: Color32::from_rgb(234,105,98),
    red: Color32::from_rgb(234,105,98),
    maroon: Color32::from_rgb(234,105,98),
    pink: Color32::from_rgb(211, 134, 155),
    mauve: Color32::from_rgb(211, 134, 155),
    peach: Color32::from_rgb(231, 138, 78),
    yellow: Color32::from_rgb(216, 166, 87),
    green: Color32::from_rgb(169, 182, 101),
    teal: Color32::from_rgb(137, 180, 130),
    sky: Color32::from_rgb(137, 180, 130),
    sapphire: Color32::from_rgb(137, 180, 130),
    blue: Color32::from_rgb(125, 174, 163),
    lavender: Color32::from_rgb(125, 174, 163),
    ...
    overlay0: Color32::from_rgb(89, 89, 89),
    surface2: Color32::from_rgb(77, 77, 77),
    surface1: Color32::from_rgb(64, 64, 64),
    surface0: Color32::from_rgb(41, 41, 41),
    base: Color32::from_rgb(29, 32, 32),
    mantle: Color32::from_rgb(25, 27, 28),
    crust: Color32::from_rgb(20, 22, 23),
};

pub const LATTE_GRUVBOX: Theme = Theme {
    rosewater: Color32::from_rgb(193, 74, 74),
    flamingo: Color32::from_rgb(193, 74, 74),
    red: Color32::from_rgb(193, 74, 74),
    maroon: Color32::from_rgb(193, 74, 74),
    pink: Color32::from_rgb(148, 94, 128),
    mauve: Color32::from_rgb(148, 94, 128),
    peach: Color32::from_rgb(195, 94, 10),
    yellow: Color32::from_rgb(180, 113, 9),
    green: Color32::from_rgb(108, 120, 46),
    teal: Color32::from_rgb(76, 122, 93),
    sky: Color32::from_rgb(76, 122, 93),
    sapphire: Color32::from_rgb(76, 122, 93),
    blue: Color32::from_rgb(69, 112, 122),
    lavender: Color32::from_rgb(69, 112, 122),
    text: Color32::from_rgb(101, 71, 53),
    subtext1: Color32::from_rgb(115, 80, 60),
    subtext0: Color32::from_rgb(128, 89, 66),
    overlay2: Color32::from_rgb(140, 98, 73),
    overlay1: Color32::from_rgb(140, 133, 109),
    overlay0: Color32::from_rgb(166, 157, 129),
    surface2: Color32::from_rgb(191, 182, 149),
    surface1: Color32::from_rgb(209, 199, 163),
    surface0: Color32::from_rgb(227, 222, 195),
    base: Color32::from_rgb(249, 245, 215),
    mantle: Color32::from_rgb(240, 235, 206),
    crust: Color32::from_rgb(232, 227, 200),
};
